...
async function realizarLogin() {
  const loginUrl = "https://84f1-189-20-197-53.ngrok-free.app/autenticacao";
  const credenciais = {
...
async function createJwt(cnpj, cpfs) {
  ...
  try {
    const consultaUrl = "https://84f1-189-20-197-53.ngrok-free.app/vt-gateway/cadastro/consulta";
